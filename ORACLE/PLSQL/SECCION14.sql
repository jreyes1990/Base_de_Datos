...
/***** HERENCIA (SE USA LA CLAUSULA UNDER PARA QUE SEA HEREDABLE) EN PL/SQL *****/
-- ELIMINANDO OBJETO
...
-- CREAR CABECERA DEL OBJETO COMESTIBLE, HEREDANDO DEL OBJETO PRODUCTO
...
/***** COLUMNAS OBJETO EN UNA TABLA EN PL/SQL *****/
-- CREAR TABLA TIENDA
CREATE TABLE TIENDA(
  CODIGO NUMBER,
  ESTANTERIA NUMBER,
...
-- CONSULTA DATOS OBJETO
SELECT T.CODIGO, T.ESTANTERIA, T.PRODUCTO.PRECIO, T.PRODUCTO.CODIGO, T.PRODUCTO.VER_PRODUCTO() FROM TIENDA T;
