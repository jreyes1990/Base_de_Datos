...
INSERT INTO REGIONS VALUES(9004,'REGION85');
COMMIT;
...
/***** TRIGGER TIPO COMPOUND DE PL/SQL *****/
CREATE OR REPLACE TRIGGER TR_TRIGGER1 FOR
...
ALTER TRIGGER TR_REGION DISABLE;
ALTER TRIGGER TR_INS_EMPL DISABLE;

-- INSERTANDO DATOS A LA TABLA , EN EL LOG_TABLE NO SE REGISTRARA LA DATA
INSERT INTO REGIONS VALUES(9004,'REGION85');
COMMIT;